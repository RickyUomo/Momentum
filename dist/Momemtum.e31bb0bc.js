...
var cryptoAry = ['bitcoin', 'dogecoin'];
var weatherKey = "c08411349473edc09f0adb1e4b05031e";
getBackgroundImage();
setInterval(getBackgroundImage, 1000000);

function getBackgroundImage() {
  _axios.default.get("https://apis.scrimba.com/unsplash/photos/random?orientation=landscape&query=nature").then(function (res) {
    var imageURL = res.data.urls.full;
    localStorage.setItem("background-image", imageURL);
    document.body.style.backgroundImage = "url(".concat(imageURL, ")");
    document.getElementById('author').innerHTML = "BY: ".concat(res.data.user.name);
  }).catch(function (e) {
...
cryptoAry.map(function (c) {
  _axios.default.get("https://api.coingecko.com/api/v3/coins/".concat(c)).then(function (res) {
    var div = document.createElement('div');
    div.setAttribute('id', 'coin');
    div.innerHTML = "\n            <div id=\"crypto-name\">\n                <img src=".concat(res.data.image.small, " /> <span>").concat(res.data.name, "</span>\n            </div>\n                <p>\uD83C\uDFAF: $").concat(res.data.market_data.current_price.usd, "</p>\n                <p>\uD83D\uDC46: $").concat(res.data.market_data.high_24h.usd, "</p>\n                <p>\uD83D\uDC47: $").concat(res.data.market_data.low_24h.usd, "</p>\n            ");
...
setInterval(function () {
  ...
  document.getElementById('time').innerHTML = "".concat(hour, ":").concat(minute, ":").concat(second);
}, 1000);
navigator.geolocation.getCurrentPosition(function (position) {
  var lat = position.coords.latitude;
  var lon = position.coords.longitude;

  _axios.default.get("https://api.openweathermap.org/data/2.5/weather?lat=".concat(lat, "&lon=").concat(lon, "&appid=").concat(weatherKey, "&units=imperial")).then(function (res) {
    var iconUrl = "https://openweathermap.org/img/wn/".concat(res.data.weather[0].icon, "@2x.png");
    var degree = Math.floor(res.data.main.temp);
    var location = res.data.name;
    weather.innerHTML = "\n                <div id=\"weather-top\">\n                    <img src=".concat(iconUrl, " />\n                    <span>").concat(degree, "\xB0F</span>\n                </div>\n                <p>").concat(location, "</p>\n            ");
...
//# sourceMappingURL=/Momemtum.e31bb0bc.js.map